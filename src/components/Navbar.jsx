...
const Navbar = () => {
  ...
  return (
    <header className="fixed w-full max-w-[1200px] mx-auto bg-[rgba(214,214,214,0.4)] opacity-100 px-4 py-2 rounded-[35px] z-50">
        ...
        <ul className="hidden md:flex items-center text-black list-none space-x-5">
          ...
          <li className="relative flex items-center">
            <button
              ...
              className="flex items-center justify-center w-10 h-10 text-black hover:bg-gray-700 rounded transition"
